...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring(
      # '/store/user/jdolen/miniAODsingle/miniAOD_RSGluonToTT_M-3000_PU_S14_001F67AD-2BC5-E311-9A0E-003048FFD756.root'
...
process.TFileService = cms.Service("TFileService",
      fileName = cms.string("histos_TTJets_premix_mini_PU40bx25_file3.root"),
...
# >>> process.patJetCorrFactorsAK15CHSfiltered.rho
